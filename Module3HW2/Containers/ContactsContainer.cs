...
namespace HW_12
{
    public class ContactsContainer
    {
        ...
        public ContactsContainer(IAlphabetConfigurationService alphabetConfigurationService, CultureInfo culture)
        {
            ...
            AlphabetConfig = _alphabetConfigurationService.DeserializeAlphabetConfig(@"C:\Users\Timmy\OneDrive\Рабочий стол\Module3HW2-Module3HW2\Module3HW2\Module3HW2\Configs\alphabet-config.json");
